...
1. Set the **[!UICONTROL Type]** for the link:
   ...
   * **Landing page** - Choose this type to select a published landing page in <!-- Journey Optimizer B2B Edition (_Beta_) or -->the connected Marketo Engage instance.
      ...
      For the **[!UICONTROL Landing Page]** option, select the published landing page. Click the _Select page_ icon ( ![Show links icon](../assets/do-not-localize/icon-landing-page-select.svg) ) and [select the published landing page](./landing-pages.md#link-to-landing-page).
...
* **[!UICONTROL Select asset]** - Choose this type to browse and select an image asset from the [!DNL Marketo Optimizer] Assets library.
...
* **[!UICONTROL Import media]** - Choose this type to select a file from your system and import it into the [!DNL Marketo Optimizer] asset library.
   ...
   ![Import an image file to the asset library](assets/email-designer-image-upload.png){width="450"}
...
1. Set the **[!UICONTROL Type]** for the link:
   ...
   * **[!UICONTROL External link]** - Choose this type to use a standard URL as the link destination.
      ...
      ![Define an external link for an image component](assets/component-button-link-options-external.png){width="250"}       

   * **Landing page** - Choose this type to select a published landing page in <!-- Journey Optimizer B2B Edition (_Beta_) or -->the connected Marketo Engage instance.

      For the **[!UICONTROL Landing Page]** option, select the published landing page. Click the _Select page_ icon ( ![Show links icon](../assets/do-not-localize/icon-landing-page-select.svg) ) and [select the published landing page](./landing-pages.md#link-to-landing-page).
      
      ![Define a link to a landing page for an image component](assets/component-button-link-options-landing-page.png){width="250"}
...
1. Click the _Form_ tool in the component toolbar, or use the **[!UICONTROL Embed Form]** properties on the right to select the published form. 
   ...
   ![Select the published form](assets/content-design-add-form-properties.png){width="600"}
...
1. If you want to override the default **[!UICONTROL Follow up type]** for the form, change the setting according to the requirements for your page or template.
   ...
   * **[!UICONTROL Landing page]** - Choose this option to select any [!DNL Marketo Optimizer] or Marketo Engage landing page as the follow-up.
   ...
   * **[!UICONTROL External URL]** - Choose this option to specify any URL as the follow-up page. After the visitor submits the form, the browser loads the designated URL.
     ...
     ![Change the follow-up setting](assets/content-design-add-form-follow-up.png){width="280"} 
